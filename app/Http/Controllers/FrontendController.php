 ...
 */
    public function index(){
        ...
        $services->slug = DB::table('categories')->where('title','programs')->value('slug');
        $our_products = DB::table('categories')->where('status','on')->get();
        $our_products->slug = DB::table('categories')->where('title','our-products')->value('slug');
