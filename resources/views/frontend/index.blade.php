...
<section id="{{$portifolio->slug}}" class="content"> 
  ...
  <div class="portfolio"> 
    ...
    <div class="portfolio_img"> <img src="{{('public/portifolios')}}/{{$port->image}}"  alt="Portfolio 1"> </div>        
  ...
  <div class="container">
    ...
    <div class="team_section clearfix">
      ...
      <div class="team_area">
        ...
        <img src="{{('public/teams')}}/{{$team->image}}" alt="">
          <ul>
      ...
      <div class="team_area">
        <div class="team_box  wow fadeInDown delay-06s">
          <div class="team_box_shadow"><a href="javascript:void(0)"></a></div>
          <img src="{{('public/frontend/img/team_pic2.jpg')}}" alt="">
          <ul>
            <li><a href="javascript:void(0)" class="fa fa-twitter"></a></li>
            <li><a href="javascript:void(0)" class="fa fa-facebook"></a></li>
            <li><a href="javascript:void(0)" class="fa fa-pinterest"></a></li>
      ...
      <div class="team_area">
        <div class="team_box wow fadeInDown delay-09s">
          <div class="team_box_shadow"><a href="javascript:void(0)"></a></div>
          <img src="{{('public/frontend/img/team_pic3.jpg')}}" alt="">
          <ul>
            <li><a href="javascript:void(0)" class="fa fa-twitter"></a></li>
            <li><a href="javascript:void(0)" class="fa fa-facebook"></a></li>
            <li><a href="javascript:void(0)" class="fa fa-pinterest"></a></li>
    ...
    <section class="page_section contact" id="contact">
      ...
      <div class="row">
        ...
        <div class="col-lg-8 wow fadeInLeft delay-06s">
          ...
          <span id="loader"><img src="{{url('public/frontend/img/loader.gif')}}" alt="sending" width="60"></span>
